...
import accordiontwo from "@/public/images/accordion2.png";
  ...
  return (
    <div className="">
      <div className=" flex justify-between mb-[1.5rem] items-center mt-[2rem] md:mt-[8rem]">
        <h1 className="font-medium text-[1.2rem] sm:text-[1.3rem] md:text-[1.5rem] flex items-center md:gap-4"><IoEarth className="text-[#0000008A]" /> Lorem Ipsum</h1>
