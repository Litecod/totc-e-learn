  ...
  return (
    <div className="w-full mx-auto px-[0.8rem] sm:px-[3rem] lg:px-[5rem] py-[2rem] md:py-[4rem] mt-[5rem] md:mt-[3rem] md:mb-[3rem]">
      <div className=" flex justify-between mb-[1.5rem] items-center">
        <h1 className="font-medium text-[1.2rem] sm:text-[1.3rem] md:text-[1.5rem]">Get choice of your course</h1>
        <h4 className="text-[#49BBBD] text-[0.9rem]">See all</h4>
      </div>
            ...
            >
              ...
              <div className="flex justify-between">
                <div className="flex gap-2 md:gap-0 lg:gap-2 items-center">
                  ...
                  <span className="text-[#393939] md:text-[0.8rem] lg:text[1rem]">
                    Design
                  </span>
                </div>
                <div className="flex gap-2 md:gap-0 lg:gap-2 items-center">
              ...
              <div className="flex justify-between">
                ...
                <div className="flex gap-2 md:gap-1 lg:gap-2 items-center">
                  <s className="text-[#393939] md:text-[0.7rem] lg:text-[1rem]">
                    $100
                  </s>{" "}
                  <p>$80</p>
                </div>
